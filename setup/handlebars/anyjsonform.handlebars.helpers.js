    ...
    function func(data, parent) {
        ...
        for (var d in data) {
            if (typeof data[d] == 'object') {
                result += '<input type="button" onclick="accordionFunction(' + d + ')" class="w3-button w3-circle w3-left-align">' + d + '</input><input type="button" class="w3-btn w3-circle" id="addchild_' + parent + d + '"><i class="fa fa-plus"></i></input>';
                result += '<div style="margin: 10px;" class="w3-card-4 w3-container" id=' + d + '>' + func(data[d], parent + d + ".") + '</div>';
